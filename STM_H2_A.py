...
def param_init_ff(options, params, prefix="lstm"):
    ...
    :see: init_params
    """
    W_ff_h1 = 0.1 * numpy.random.randn(2 * options['dim_hidden'],
...
def grid_lstm_cube(tparams, origin_data, options, prefix='lstm', mask=None):
    ...
    proj_h1 = tensor.stack(out_list_1)
    proj_c1 = tensor.stack(out_list_c1)
    proj = tensor.concatenate([proj_h1, proj_c1], axis=2)
